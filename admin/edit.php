...
// get place info
$place_query = mysqli_query($GLOBALS['cxn'], "SELECT * FROM places WHERE id='$place_id' LIMIT 1");
...
if($task == "doedit") {
  ...
  mysqli_query($GLOBALS['cxn'], "UPDATE places SET title='$title', type='$type', address='$address', uri='$uri', lat='$lat', lng='$lng', description='$description', owner_name='$owner_name', owner_email='$owner_email' WHERE id='$place_id' LIMIT 1") or die(mysqli_error($GLOBALS['cxn']));
