...
// connect to db
$cxn = mysqli_connect($db_host, $db_user, $db_pass, $db_name) or die(mysqli_error($GLOBALS['cxn']));

// get marker totals
$total_approved = mysqli_num_rows(mysqli_query($GLOBALS['cxn'], "SELECT id FROM places WHERE approved='1'"));
$total_rejected = mysqli_num_rows(mysqli_query($GLOBALS['cxn'], "SELECT id FROM places WHERE approved='0'"));
$total_pending = mysqli_num_rows(mysqli_query($GLOBALS['cxn'], "SELECT id FROM places WHERE approved IS null"));
$total_all = mysqli_num_rows(mysqli_query($GLOBALS['cxn'], "SELECT id FROM places"));
